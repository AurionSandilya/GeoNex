...
class Settings(BaseSettings):
    ...
    M3_SERVICE_KEY: str = Field(default="m3-m5-internal-shared-key", description="Expected value of X-Internal-Service-Key for M3 -> M5 calls")
    M5_SERVICE_KEY: str = Field(default="m3-m5-internal-shared-key", description="Key M5 presents when calling back out, if required")
    ...
    M3_BASE_URL: str = Field(default="http://localhost:8000", description="Base URL for M3 API")
