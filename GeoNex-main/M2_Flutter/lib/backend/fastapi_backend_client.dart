...
class FastApiBackendClient implements BackendClient {
  ...
  // ---------------------------------------------------------------------------
  // HTTP Helpers (pure dart:io - zero external package dependency required)
  // ---------------------------------------------------------------------------
        ...
        return data.map<CitizenReport>((item) {
          ...
          final verStatus = statusStr == 'VERIFIED'
              ...
              : statusStr == 'REJECTED'
                  ...
                  : ReportVerificationStatus.pending;
      ...
      try {
        return data.map<AlertModel>((item) {
          ...
          return AlertModel(
            ...
            status: alertStatus,
            deliveryChannels: [DeliveryChannel.sms, DeliveryChannel.push, DeliveryChannel.inApp],
